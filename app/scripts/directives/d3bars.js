...
/**
 * @ngdoc directive
 * @name jalousieRemoteApp.directive:d3Bars
 * @description
 * # d3Bars
 */
      ...
      return {
        ...
        link: function(scope, iElement, iAttrs) {
          ...
          scope.render = function(data){
            ...
            height = scope.data.length * (scope.lineHeight + 5);
            ...
            var r1 = svg.selectAll("rect")
              .data(data)
              .enter();

                r1.append("rect")
                .attr("fill", "#5cb85c") //#f0ad4e
